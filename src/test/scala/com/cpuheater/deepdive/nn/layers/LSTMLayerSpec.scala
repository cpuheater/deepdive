...
class LSTMLayerSpec extends TestSupport {
  ...
  it should "LSTM" in {
   ...
   // Nd4j.setDataType(DataBuffer.Type.DOUBLE)
    ...
    ,-0.3763567,  -0.34227539,  0.29490764)).reshape(Array(n, t, d): _*)
    ...
    val wx = Nd4j.create(Array(-0.83732373,  0.95218767,  1.32931659,  0.52465245, -0.14809998,  0.88953195,
    ...
    -0.32156083,  0.56834936, -0.19961722,  1.27286625,  1.27292534,  1.58102968)).reshape(d, 4*h)



    val wh = Nd4j.create(Array(-1.75626715,  0.9217743,  -0.6753054,  -1.43443616,  0.47021125,  0.03196734,
    ...
    ,-0.22319022, -0.82993433, -1.11271826, -0.44613095, -0.40001719,  0.36343905)).reshape(d, 4 * h)

    val b = Nd4j.create(Array( 0.94992777, -0.32379447,  0.27031704, -0.63381148, -2.71484268,  0.65576139,
    ...
    ArrayUtil.equals(out.data().asFloat(), Array(-0.3376217864862354,-0.05721515406754319,-0.0699434180217775,-0.25060848853834816,-0.03201792135091604,-0.28208066528756387,-0.31773550521415583,-0.030992890483065087,-0.04423168394911765,-0.026895381867943404,0.004410798590859912,-0.2353102734169302)) should be(true)



    val dout = Nd4j.create(Array( 0.53770564, -0.12171369, -1.04250949,
      0.13828792, -0.22557183, -1.1928829,
      -0.68320696,  0.19909408,  0.03070661,
      -0.44972639,  0.14447532, -0.35229594)).reshape(out.shape():_*)
